...
namespace MvcGuestbook.Models
{
    public class GuestBookDataSource
    {
        ...
        private GuestBookTableServiceContext context;
        ...
        static GuestBookDataSource()
        {
            ...
            CloudTableClient.CreateTablesFromModel(
                typeof(GuestBookTableServiceContext),
        ...
        {
            this.context = new GuestBookTableServiceContext(storageAccount.TableEndpoint.AbsoluteUri, storageAccount.Credentials);
